export const HUBSPOT_OBJECT_PROPERTIES: Record<string, string[]> = {
  ...
  deals: [
    ...
    'prp_session_14_date',
    'prp_session_15_date',
    'prp_session_1_status',
    'prp_session_2_status',
    'prp_session_3_status',
    'prp_session_4_status',
    'prp_session_5_status',
    'prp_session_6_status',
    'prp_session_7_status',
    'prp_session_8_status',
    'prp_session_9_status',
    'prp_session_10_status',
    'prp_session_11_status',
    'prp_session_12_status',
    ...
    'prp_session_8_notes',
    'prp_session_9_notes',
    'prp_session_10_notes',
    'prp_session_11_notes',
    'prp_session_12_notes',
    'prp_session_13_notes',
    'prp_session_14_notes',
    'prp_session_15_notes',
  ],
